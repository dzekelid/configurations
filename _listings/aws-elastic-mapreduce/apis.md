...
- name: AWS Elastic MapReduce API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/configurations/master/_listings/aws-elastic-mapreduce/action-deletesecurityconfiguration-get.md
x-common:
- type: x-article
