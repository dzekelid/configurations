...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/configurations/master/_listings/akamai/etp-report-v1-configs-configid-aup-events-time-series-starttimesec,endtimesec,dimension,filters-get.md
x-common:
- type: x-base
