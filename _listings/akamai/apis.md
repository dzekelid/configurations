...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/configurations/master/_listings/akamai/etp-report-v1-configs-configid-aup-events-details-starttimesec,endtimesec,dimension,filters-get.md
x-common:
- type: x-base
