...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/configurations/master/_listings/akamai/config-secure-provisioning-service-v1-sps-requests-contractid,groupid,after,information-get.md
x-common:
- type: x-base
