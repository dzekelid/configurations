...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/configurations/master/_listings/akamai/config-gtm-v1-domains-domain-datacenters-datacenterid-put.md
x-common:
- type: x-base
