...
- name: Akamai API Get a Data Center
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/configurations/master/_listings/akamai/config-gtm-v1-domains-domain-datacenters-datacenterid-get.md
x-common:
- type: x-base
