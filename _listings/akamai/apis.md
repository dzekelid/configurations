...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/configurations/master/_listings/akamai/etp-report-v1-configs-configid-threat-events-aggregate-starttimesec,endtimesec,dimension,filters-get.md
x-common:
- type: x-base
