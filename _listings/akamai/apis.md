...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/configurations/master/_listings/akamai/config-saas-registration-v1-customers-surrogateid-contractid-get.md
x-common:
- type: x-base
