...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/configurations/master/_listings/akamai/config-gtm-v1-domains-domain-geographic-maps-mapname-get.md
x-common:
- type: x-base
