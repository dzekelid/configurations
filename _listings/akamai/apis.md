...
- name: Akamai API Modify a Pair
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/configurations/master/_listings/akamai/config-saas-registration-v1-pairs-surrogateid-put.md
x-common:
- type: x-base
