...
- name: Akamai API Report DNS Activity Time Series
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/configurations/master/_listings/akamai/etp-report-v1-configs-configid-dns-activities-time-series-get.md
x-common:
- type: x-base
